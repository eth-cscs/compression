...
function [TT] = lanczos_pca_ind_mone(GammaInd, X, Theta, myseed)
...
%
%   In this case all the Gamma probability is concentrated into one
%   index, thus GammaInd is merely one index vector.
%
...
s = RandStream('mcg16807','Seed',myseed);
